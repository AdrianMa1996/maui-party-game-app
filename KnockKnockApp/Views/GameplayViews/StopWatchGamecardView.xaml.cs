...
public partial class StopWatchGamecardView : ContentView
{
    ...
    public static readonly BindableProperty TemplateSizeProperty = BindableProperty.Create(nameof(TemplateSize), typeof(int), typeof(StopWatchGamecardView));
    ...
    public static readonly BindableProperty NumberOfPlayedTemplateCardsProperty = BindableProperty.Create(nameof(NumberOfPlayedTemplateCards), typeof(int), typeof(StopWatchGamecardView));
