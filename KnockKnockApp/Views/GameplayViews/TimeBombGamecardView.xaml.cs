...
{
    public static readonly BindableProperty IsGameRunningProperty = BindableProperty.Create(nameof(IsGameRunning), typeof(bool), typeof(TimeBombGamecardView), propertyChanged: OnIsGameRunningChanged);
    ...
    public static readonly BindableProperty SettingsProperty = BindableProperty.Create(nameof(Settings), typeof(Settings), typeof(TimeBombGamecardView));
    ...
    public static readonly BindableProperty TemplateSizeProperty = BindableProperty.Create(nameof(TemplateSize), typeof(int), typeof(TimeBombGamecardView));
    ...
    public static readonly BindableProperty NumberOfPlayedTemplateCardsProperty = BindableProperty.Create(nameof(NumberOfPlayedTemplateCards), typeof(int), typeof(TimeBombGamecardView));
