...
{
    public static readonly BindableProperty CurrentCardProperty = BindableProperty.Create(nameof(CurrentCard), typeof(GameCardDto), typeof(ScoreGamecardView), propertyChanged: OnGamecardChanged);

    static void OnGamecardChanged(BindableObject bindable, object oldValue, object newValue)
    {
        ScoreGamecardView gamecardView = (ScoreGamecardView)bindable;
    ...
    public static readonly BindableProperty TemplateSizeProperty = BindableProperty.Create(nameof(TemplateSize), typeof(int), typeof(ScoreGamecardView));
    ...
    public static readonly BindableProperty NumberOfPlayedTemplateCardsProperty = BindableProperty.Create(nameof(NumberOfPlayedTemplateCards), typeof(int), typeof(ScoreGamecardView));
